...
foreach($ranges as $kk=>$vv) 
 { 
    ...
    $styles .= " td.total_cnt_interval:nth-child(".(substr($kk,0,1)+4).") { background-color:".substr($kk,1)." !important; }";    
...
$sql_bars = $gsql->groupsIntervals($ranges);
...
<tr><td>№</td>
    ...
    <td>Диаграмма</td>
    <td>
         <button id='day' class='sign'  onclick='getCacheStat(\"h\");'>Час</button>
