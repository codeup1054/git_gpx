     ...
     switch (m.gpxSet)
        {
            ...
            default: 
                    ...
                    [setName,pointName,p_pos,set_id,gpx_id] = m.gpx_id.split('|');
...
//                    console.log("@@ text=", text_lines);
                    ...
                    var [size,r] = (set_type == 0)?[10,5]:[14,7];
                    ...
                    if (globalSettings.markerLableOnOff.on )
                    {
                     ...
                     else
                     {
                        ...
                        var fill = ( p_pos != 0 ) ? prop.fill : 'white';
                        var stroke = ( p_pos != 0 ) ? 'white' : 'black';
                        
//                        console.log('@@ orange', set_type,m); 
                        
                        var url = m.url || 'data:image/svg+xml;utf-8, \
                        <svg width="'+size+'" height="'+size+'" xmlns="http://www.w3.org/2000/svg"> \
                        <circle fill="'+fill+'" stroke="'+stroke+'" fill-opacity="0.7" stroke-width="1"  \
                        cx="'+r+'" cy="'+r+'" r="'+r+'"/> \
                        </svg>';
                     }   
